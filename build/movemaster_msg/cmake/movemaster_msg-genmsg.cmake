...
set(MSG_I_FLAGS "-Imovemaster_msg:/Users/marcoreis/mvmaster_ws/src/movemaster_msg/msg;-Istd_msgs:/Users/marcoreis/miniforge3/envs/ros_env/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/Users/marcoreis/mvmaster_ws/src/movemaster_msg/msg/setpoint.msg" NAME_WE)
add_custom_target(_movemaster_msg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "movemaster_msg" "/Users/marcoreis/mvmaster_ws/src/movemaster_msg/msg/setpoint.msg" ""
)

get_filename_component(_filename "/Users/marcoreis/mvmaster_ws/src/movemaster_msg/msg/status.msg" NAME_WE)
add_custom_target(_movemaster_msg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "movemaster_msg" "/Users/marcoreis/mvmaster_ws/src/movemaster_msg/msg/status.msg" ""
)
...
### Generating Module File
_generate_module_eus(movemaster_msg
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/movemaster_msg
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(movemaster_msg_generate_messages_eus
...
# target for backward compatibility
add_custom_target(movemaster_msg_geneus)
add_dependencies(movemaster_msg_geneus movemaster_msg_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS movemaster_msg_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(movemaster_msg
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/movemaster_msg
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(movemaster_msg_generate_messages_lisp
...
# target for backward compatibility
add_custom_target(movemaster_msg_genlisp)
add_dependencies(movemaster_msg_genlisp movemaster_msg_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS movemaster_msg_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(movemaster_msg
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/movemaster_msg
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(movemaster_msg_generate_messages_nodejs
...
# target for backward compatibility
add_custom_target(movemaster_msg_gennodejs)
add_dependencies(movemaster_msg_gennodejs movemaster_msg_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS movemaster_msg_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/movemaster_msg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/movemaster_msg
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(movemaster_msg_generate_messages_eus std_msgs_generate_messages_eus)
endif()

if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/movemaster_msg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/movemaster_msg
    DESTINATION ${genlisp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_lisp)
  add_dependencies(movemaster_msg_generate_messages_lisp std_msgs_generate_messages_lisp)
endif()

if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/movemaster_msg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/movemaster_msg
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(movemaster_msg_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/movemaster_msg)
  install(CODE "execute_process(COMMAND \"/Users/marcoreis/miniforge3/envs/ros_env/bin/python3.11\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/movemaster_msg\")")
  # install generated code
  install(

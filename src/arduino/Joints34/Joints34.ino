...
#define PWM_MAX_3_CW      130       //Max value for the joint 3 PWM when needs to go CW.
#define PWM_MIN_3_CW      0         //Min value for the joint 3 PWM when needs to go CW.

#define PWM_MAX_3_CCW     255       //Max value for the joint 3 PWM when needs to go CCW (against gravity).
#define PWM_MIN_3_CCW     180       //Min value for the joint 3 PWM when needs to go CCW (against gravity).

#define PWM_MAX_4         180       //Max value for the joint 4 PWM.
#define PWM_MIN_4         40        //Min value for the joint 4 PWM.
